...
namespace FoodHealthModulo1Final.Controllers
{
    public class DocumentTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DocumentTypeID,NameDocument")] DocumentType documentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DocumentTypeID,NameDocument")] DocumentType documentType)
        {
            if (ModelState.IsValid)
            {
