<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerClien.aspx.cs" Inherits="Vista.Admin.VerClien" %>
...
<body style="background-image:url('https://besthqwallpapers.com/img/original/39662/box-with-fresh-vegetables-fruit-healthy-food-concepts-tomatoes-cucumbers.jpg'); background-repeat:no-repeat; background-size:cover;">
  ...
  <div class="dropdown-menu bg-success">
    ...
    <a class="dropdown-item text-white bg-success" href="AgregarEmple.aspx">Agregar empleados</a>
            ...
            <center><h1 class="text-white"</h1>VER CLIENTES</center>
            ...
            <table class="table table-active bg-success">
                <tr>
                    <td><center>
                        <asp:GridView ID="gvClientes" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="gvClientes_SelectedIndexChanged">
        ...
        <div id="Modificar" runat="server">
            ...
            <center><h1 class="text-white">MODIFICAR CLIENTES</h1></center>
  ...
  <div class="container register-form">
                <div class="form-content">
                    <div class="row">
                        ...
                        <asp:TextBox ID="txtDocumento" runat="server" CssClass="form-control" MaxLength="10" TextMode="Number"></asp:TextBox>
                                <asp:HiddenField ID="hdclienteID" runat="server" />
                                <asp:HiddenField ID="hddocumentoCliente" runat="server" />
                            </div>
                            <div class="form-group">
