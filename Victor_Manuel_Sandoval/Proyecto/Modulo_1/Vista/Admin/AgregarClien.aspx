<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarClien.aspx.cs" Inherits="Vista.Admin.AgregarClien" %>
  ...
  <div class="dropdown-menu bg-success">
    ...
    <form runat="server">
        <div style="margin-top:20px;">
            <center><h1 class="text-white">AGREGAR CLIENTES</h1></center>
        </div>
